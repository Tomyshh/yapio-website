...
export const translations = {
  fr: {
    nav: {
      ...
      callPhoneWithNumber: 'Appeler {n}',
      langPicker: { fr: 'Français', en: 'Anglais', he: 'Hébreu' },
    },
    blogPage: {
    ...
    projects: {
      ...
      externalSiteAria: 'Ouvrir le site de {name} dans un nouvel onglet',
      imagePreviewAlt: 'Aperçu — {name}',
    },
    contact: {
      ...
      form: {
        ...
        selectPlaceholder: '---',
        errors: {
          notConfigured: 'Le service de contact n\'est pas configuré. Veuillez contacter l\'administrateur.',
          requiredFields: 'Les champs nom, email et message sont obligatoires.',
          invalidEmail: 'Veuillez saisir une adresse email valide.',
          dbPermission: 'Problème de permissions dans la base de données. Contactez l\'administrateur.',
          submitFailed: 'Une erreur est survenue lors de l\'envoi. Veuillez réessayer.',
        },
      },
      worldwideService: 'Intervention internationale',
      projectTypes: {
    ...
    testimonials: {
      ...
      goToTestimonial: 'Aller au témoignage {n}',
    },
    expertise: {
    ...
    about: {
      ...
      founderAttribution: '— Tom Jami, fondateur de YAPIO',
    ...
    footer: {
      ...
      whatsappFabAria: 'Contacter sur WhatsApp',
  ...
  en: {
    nav: {
      ...
      callPhoneWithNumber: 'Call {n}',
      langPicker: { fr: 'French', en: 'English', he: 'Hebrew' },
    },
    blogPage: {
    ...
    projects: {
      ...
      externalSiteAria: 'Open {name}\'s site in a new tab',
      imagePreviewAlt: 'Preview — {name}',
    },
    contact: {
      title: 'Contact Us',
      ...
      form: {
        ...
        selectPlaceholder: '---',
        errors: {
          notConfigured: 'Contact service is not configured. Please contact the administrator.',
          requiredFields: 'Name, email, and message are required.',
          invalidEmail: 'Please enter a valid email address.',
          dbPermission: 'Database permission issue. Please contact the administrator.',
    ...
    about: {
      ...
      founderQuote:
        '« Free demo, no commitment. At YAPIO, every project is run with rigor, transparency and attention to detail — to deliver a clear, high-performing and lasting solution. Our priority: your satisfaction, from the first conversation to go-live. »',
      founderAttribution: '— Tom Jami, founder of YAPIO',
    ...
    footer: {
      ...
      whatsappFabAria: 'Contact us on WhatsApp',
  ...
  he: {
    nav: {
      ...
      ariaOpenMenu: 'פתח תפריט',
      ariaCloseMenu: 'סגור תפריט',
      callPhoneWithNumber: 'חייג ל־{n}',
      langPicker: { fr: 'צרפתית', en: 'אנגלית', he: 'עברית' },
    },
    blogPage: {
    ...
    projects: {
      ...
      enlargePreview: 'הגדלה',
      closeImageAria: 'סגור תמונה',
      pageEyebrow: 'תיק עבודות',
      filters: {
        all: 'הכל',
        web: 'אינטרנט',
        mobile: 'מובייל',
      ...
      logoAlt: 'לוגו {name}',
      externalLinkTitle: 'פתח קישור חיצוני',
      externalSiteAria: 'פתח את אתר {name} בלשונית חדשה',
      imagePreviewAlt: 'תצוגה מקדימה — {name}',
    },
    contact: {
      title: 'צור קשר',
      ...
      form: {
        ...
        selectPlaceholder: '---',
        errors: {
          notConfigured: 'שירות יצירת הקשר אינו מוגדר. אנא פנה למנהל המערכת.',
          requiredFields: 'שדות השם, האימייל וההודעה הם חובה.',
          invalidEmail: 'אנא הזן כתובת אימייל תקינה.',
          dbPermission: 'בעיית הרשאות במסד הנתונים. אנא פנה למנהל המערכת.',
          submitFailed: 'אירעה שגיאה בשליחה. אנא נסה שוב.',
        },
      },
      projectTypes: {
      ...
      worldwideService: 'שירות בינלאומי',
    },
    testimonials: {
      badge: 'המלצות לקוחות',
    ...
    about: {
      ...
      founderQuote:
        '« הדגמה בחינם, ללא התחייבות. ב-YAPIO כל פרויקט מנוהל ברמה גבוהה, בשקיפות ובשימת לב לפרטים — כדי לספק פתרון ברור, בעל ביצועים ובר-קיימא. העדיפות שלנו: שביעות הרצון שלכם, מהשיחה הראשונה ועד העלייה לאוויר. »',
      founderAttribution: '— טום ג׳אמי, מייסד YAPIO',
      cta: 'בוא נעבוד ביחד',
      stats: {
        clients: 'לקוחות מרוצים',
        projects: 'פרויקטים שהושלמו',
    ...
    footer: {
      ...
      whatsappFabAria: 'יצירת קשר בוואטסאפ',
